...
Now we will look at the demand curve (equation (3) in the paper). The paper specifies per capita demand ($X_t$/$N_t$) in terms of price and other variables. ($𝛼_0$) is the demand curve intercept:

$log (𝑋_t/𝑁_t)=𝛼_0−1.13 log(𝑃_t)+1.75 log(𝑌_t/𝑁_t)−0.97 log𝐹_t$
